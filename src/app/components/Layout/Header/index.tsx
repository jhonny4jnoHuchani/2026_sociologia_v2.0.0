...
const Header: React.FC = () => {
  ...
  const headerBg = isDark
    ? scrolled ? 'var(--color-header-dark-scrolled)' : 'var(--color-header-dark)'
  ...
  return (
    <>
      ...
      {/* Portal — overlay y menú FUERA del header */}
      {mounted && createPortal(
        <>
          ...
          <div
            ...
            style={{
              backgroundColor: isDark ? 'var(--color-mobile-menu-dark)' : '#ffffff',
            }}
          >
